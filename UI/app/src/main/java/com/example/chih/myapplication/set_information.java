...
public class set_information extends AppCompatActivity {
    ...
    String getId;
    private static String URL_READ = " http://100.76.25.173/android_register_login/read_detail.php";// 連結php 讀取資料的檔案   http://127.0.0.1/android_register_login/read_detail.php
    private static String URL_EDIT = "http://100.76.25.173/android_register_login/edit_detail.php";//連結php 編輯資料的檔案   http://127.0.0.1/android_register_login/edit_detail.php
    private Menu action;
